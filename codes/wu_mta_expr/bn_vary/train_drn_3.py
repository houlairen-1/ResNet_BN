...
def process():
    ...
    with tf.Session() as sess:
        ...
        train_writer = tf.summary.FileWriter("/home/liugq/Workspace/ResNet_BN/data/logs/2018.01/drn_3/train",sess.graph)
        test_writer = tf.summary.FileWriter("/home/liugq/Workspace/ResNet_BN/data/logs/2018.01/drn_3/test")
        summary1 = tf.Summary()
        summary2 = tf.Summary()
        cover_count = 0
        stego_count = 0
        for i in range(1,NUM_ITER+1):
            ...
            if i%NUM_SHOWTRAIN==0:  
                ...
                print 'DRN resnet_shi_3 result'
                print 'epoch:', i
                print 'loss:', c
                print 'accuracy:', temp
                print ' '
            if i%(30000)==0:
                saver.save(sess,'../../data/models/2018.01/DRN_resnet_3_'+str(i)+'.ckpt')
            if i%NUM_SHOWTEST==0:
