...
def process():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess,"/home/liugq/Workspace/ResNet_BN/data/models/2018.01/DRN_resnet_2_180000.ckpt")
        test_writer = tf.summary.FileWriter("/home/liugq/Workspace/ResNet_BN/data/logs/2018.01/drn_2/test/batch_1/bn_constant")
        cover_count = 0
        stego_count = 0
